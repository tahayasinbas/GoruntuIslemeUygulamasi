...
class ImageProcessingApp:
    ...
    def execute_negative(self):
        ...
        self.processed_image = hafta1.negatif_al(self.original_image.copy())
        self.display_images()
    ...
    def execute_show_channel(self, channel):
        ...
        self.processed_image = hafta1.kanali_goster(self.original_image.copy(), channel)
        self.display_images()
    ...
    def execute_split_channels(self):
        ...
        # Kanallarına ayır
        b, g, r = hafta1.kanallara_ayir(self.original_image.copy())
        ...
        blue_image = hafta1.kanali_goster(self.original_image.copy(), "blue")
        # Yeşil kanal
        green_image = hafta1.kanali_goster(self.original_image.copy(), "green")
        # Kırmızı kanal
        red_image = hafta1.kanali_goster(self.original_image.copy(), "red")
        ...
        self.display_on_canvas(gray_canvas, hafta1.griye_cevir(self.original_image.copy()))
    ...
    def execute_brightness_adjustment(self, brightness_value, fast_mode=True):
        ...
        if fast_mode:
            self.processed_image = hafta2.parlaklik_ayarla_hizli(self.original_image.copy(), brightness_value)
        else:
            self.processed_image = hafta2.parlaklik_ayarla(self.original_image.copy(), brightness_value)
    ...
    def execute_contrast_adjustment(self, mode, alpha, beta, show_histogram):
        ...
        if mode == "kontrast_ayarla":
            self.processed_image = hafta2.kontrast_ayarla(self.original_image.copy(), alpha, beta)
            operation_name = f"Kontrast ayarlandı (Alpha: {alpha:.2f}, Beta: {beta})"
        else:  # kontrast_germe
            self.processed_image = hafta2.kontrast_germe(self.original_image.copy(), show_histogram)
    ...
    def execute_threshold(self, threshold_value, max_value, fast_mode=True):
        ...
        # Seçilen moda göre işlevi çağır
        if fast_mode:
            self.processed_image = hafta2.esikleme_hizli(self.original_image.copy(), threshold_value, max_value)
        else:
            self.processed_image = hafta2.esikleme(self.original_image.copy(), threshold_value, max_value)
    ...
    def execute_histogram_equalization(self, show_histogram):
        ...
        self.processed_image = hafta2.histogram_esitleme(self.original_image.copy(), show_histogram)
    ...
    def execute_translation(self, dx, dy):
        ...
        self.processed_image = hafta3.tasima(self.original_image.copy(), dx, dy)
        self.display_images()
    ...
    def execute_horizontal_mirror(self):
        ...
        self.processed_image = hafta3.aynalama_yatay(self.original_image.copy())
        self.display_images()
    ...
    def execute_vertical_mirror(self):
        ...
        self.processed_image = hafta3.aynalama_dikey(self.original_image.copy())
        self.display_images()
    ...
    def execute_both_axis_mirror(self):
        ...
        self.processed_image = hafta3.aynalama_her_iki_eksen(self.original_image.copy())
        self.display_images()
    ...
    def execute_shearing(self, shear_type, shear_amount):
        ...
        if shear_type == "x":
            self.processed_image = hafta3.egme_x(self.original_image.copy(), shear_amount)
            axis_name = "X"
        else:  # y ekseni
            self.processed_image = hafta3.egme_y(self.original_image.copy(), shear_amount)
            axis_name = "Y"
        ...
        if use_manual and scale_factor > 1.0:
            try:
                ...
                if scale_factor_int < 1:
                    scale_factor_int = 1
                self.processed_image = hafta3.olcekleme_manuel(self.original_image.copy(), scale_factor_int)
            ...
            # Normal ölçekleme
            self.processed_image = hafta3.olcekleme(self.original_image.copy(), scale_factor, interpolation_method)
    ...
    def execute_cropping(self, crop_method):
        ...
        if crop_method == "manual":
            ...
            cropped_image = hafta3.mouse_ile_kirp(self.original_image.copy())
            ...
            try:
                ...
                self.processed_image = hafta3.kirpma(self.original_image.copy(), x, y, width, height)
                self.display_images()
    ...
    def execute_perspective_correction(self, method):
        ...
        if method == "interactive":
            ...
            if scale_factor != 1.0:
                disp_img = cv2.resize(self.original_image.copy(), (0, 0), fx=scale_factor, fy=scale_factor)
            else:
                disp_img = self.original_image.copy()
    ...
    def execute_mean_filter(self, kernel_size, manual_mode=False):
        ...
        if manual_mode:
            self.processed_image = hafta5.ortalama_filtre_manuel(self.original_image.copy(), kernel_size)
            filter_name = "Manuel ortalama filtre"
        else:
            self.processed_image = hafta5.ortalama_filtre(self.original_image.copy(), kernel_size)
    ...
    def execute_median_filter(self, kernel_size, manual_mode=False):
        ...
        # Manuel mod veya OpenCV kullanımı seçimine göre işlev çağır
        if manual_mode:
            self.processed_image = hafta5.medyan_filtre_manuel(self.original_image.copy(), kernel_size)
            filter_name = "Manuel medyan filtre"
        else:
            self.processed_image = hafta5.medyan_filtre(self.original_image.copy(), kernel_size)
    ...
    def execute_gaussian_filter(self, kernel_size, sigma, manual_mode=False):
        ...
        # Manuel mod veya OpenCV kullanımı seçimine göre işlev çağır
        if manual_mode:
            self.processed_image = hafta5.gauss_filtre_manuel(self.original_image.copy(), kernel_size, sigma)
            filter_name = "Manuel Gauss filtresi"
        else:
            self.processed_image = hafta5.gauss_filtre(self.original_image.copy(), kernel_size, sigma)
    ...
    def execute_conservative_filter(self):
        ...
        # Filtreyi uygula
        self.processed_image = hafta5.konservatif_filtre(self.original_image.copy())
    ...
    def execute_crimmins_speckle(self, iterations):
        ...
        # Filtreyi uygula
        self.processed_image = hafta5.crimmins_speckle_filtre(self.original_image.copy(), iterations)
    ...
    def execute_fourier_transform(self):
        ...
        hafta5.goruntu_fft_goster(self.original_image.copy())
    ...
    def execute_low_pass_filter(self, cutoff_frequency):
        ...
        # Filtreyi uygula
        self.processed_image = hafta5.alcak_geciren_filtre(self.original_image.copy(), cutoff_frequency)
    ...
    def execute_high_pass_filter(self, cutoff_frequency):
        ...
        # Filtreyi uygula
        self.processed_image = hafta5.yuksek_geciren_filtre(self.original_image.copy(), cutoff_frequency)
    ...
    def execute_sobel(self, kernel_size, output_mode):
        ...
        sobel_x, sobel_y, sobel_magnitude = hafta6.sobel_kenar_bulma(self.original_image.copy(), kernel_size)
    ...
    def execute_prewitt(self, output_mode):
        ...
        prewitt_x, prewitt_y, prewitt_magnitude = hafta6.prewitt_kenar_bulma(self.original_image.copy())
    ...
    def execute_roberts_cross(self, output_mode):
        ...
        roberts_x, roberts_y, roberts_magnitude = hafta6.roberts_cross_kenar_bulma(self.original_image.copy())
    ...
    def execute_compass(self):
        ...
        self.processed_image = hafta6.compass_kenar_bulma(self.original_image.copy())
    ...
    def execute_hough_lines(self, kernel_size, theta, threshold):
        ...
        lines = hafta7.hough_cizgi_algilama(self.original_image.copy(), kernel_size, theta, threshold)
        
        self.processed_image = hafta7.cizgi_cizdir(self.original_image.copy(), lines)
        self.display_images()
    ...
    def execute_hough_circles(self, kernel_size, threshold):
        ...
        circles = hafta7.hough_cember_algilama(self.original_image.copy(), kernel_size, threshold)
        
        self.processed_image = hafta7.cember_cizdir(self.original_image.copy(), circles)
        self.display_images()
    ...
    def execute_erosion(self, kernel_size):
        ...
        # Yükleme durumunu güncelle
        self.update_status("Aşındırma uygulanıyor...")
        
        # Aşındırma işlemini uygula
        self.processed_image = hafta7.erosion(self.original_image.copy(), kernel_size)
        
        self.display_images()
        self.update_status(f"Aşındırma uygulandı (Çekirdek: {kernel_size}x{kernel_size}).")
    ...
    def execute_dilation(self, kernel_size):
        ...
        self.processed_image = hafta7.dilation(self.original_image.copy(), kernel_size)
    ...
    def execute_opening(self, kernel_size):
        ...
        self.processed_image = hafta7.opening_islem(self.original_image.copy(), kernel_size=kernel_size)
        self.display_images()
    ...
    def execute_closing(self, kernel_size):
        ...
        self.processed_image = hafta7.closing_islem(self.original_image.copy(), kernel_size=kernel_size)
        self.display_images()
        self.update_status(f"Kapama işlemi tamamlandı (kernel boyutu: {kernel_size}x{kernel_size}).")

    # Menüdeki "Griye Çevir" işlemi için metot tanımı eksik
    def griye_cevir(self):
        ...
        # Görüntüyü gri tonlamaya çevir
        self.processed_image = hafta1.griye_cevir(self.original_image.copy())
        self.display_images()
